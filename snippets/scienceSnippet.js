const scienceSnippets = [
  ...
  "Fibrodysplasia ossificans progressiva is a disorder that progressively turns human muscle tissue into bone, eventually resulting in bone formation outside of the skeleton.",
  ...
  "You're more likely to be able to survive a grenade on land rather than underwater",
  ...
  "Polar bears are nearly undetectable by infrared cameras. This is because thermal cameras detect the heat lost by a subject as infrared rays, but due to their thick layer of blubber, polar bears are excellent at conserving heat.",
  "It takes 8 minutes, 19 seconds for light to travel from the Sun to the Earth. In space, light travels at 300,000km per second, and the distance from the Eart to the Sun is 150 million km.",
  "If you removed all the empty space in our atoms, the human race could fit in the volume of a sugar cube. Matter is made of up atoms, which are over 99.99999% empty space. An atom consists of a tiny, dense nucleus surrounded by an electron cloud that is spread over a proportionately vast area.",

];

function scienceSnippet() {
  return scienceSnippets[Math.floor( Math.random() * scienceSnippets.length )];
}
